                                ...
                                <div class="col-md-8">
                                    <select name="bekasi_section" id="bekasi_section" class="form-control select2-container"
                                        ...
                                        @foreach ($bekasiSections as $section)
                                            <option value="{{ $section->bekasi_section }}">
                                                {{ $section->bekasi_section }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group row input-group input-group-lg">
                                ...
                                <div class="col-md-8">
                                    <select name="price" id="price" class="form-control select2-container" required>
                                        ...
                                        <option value="1">Dibawah 15000</option>
                                        <option value="15000">Mulai 15000</option>
                                        <option value="20000">Mulai 20000</option>
                                        <option value="30000">Lebih dari 30000</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row input-group input-group-lg">
                                ...
                                <div class="col-md-8">
                                    <select name="start" id="start" class="form-control select2-container" required>
                                        ...
                                        <option value="1">Pagi (06:00 - 10:00)</option>
                                        <option value="2">Siang (10:00 - 14:00)</option>
                                        <option value="3">Sore (14:00 - 18:00)</option>
                                        <option value="4">Malam (diatas 18:00)</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row input-group input-group-lg">
